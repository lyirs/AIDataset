...
| 38 | SUN397 | Visual | [Site](https://3dvision.princeton.edu/projects/2010/SUN/) | Research only / custom | Scene recognition and scene-centric transfer | [Paper](https://3dvision.princeton.edu/projects/2010/SUN/paper.pdf) | Still the canonical scene-recognition benchmark that complements Places-style evaluation. |
| 39 | COCO-Stuff | Visual | [GitHub](https://github.com/nightrome/cocostuff) | Mixed / COCO terms + CC BY 4.0 annotations | Thing-and-stuff semantic segmentation | [Paper](https://arxiv.org/abs/1612.03716) | A standard dense-label extension of COCO used in semantic, panoptic, and open-vocabulary segmentation papers. |
| 40 | Office-31 | Visual | [Site](https://faculty.cc.gatech.edu/~judy/domainadapt/) | Unknown | Classic small-scale domain adaptation | [Paper](http://www.cs.uml.edu/~saenko/projects/eccv10.pdf) | Still the backward-compatibility benchmark that many DA papers report alongside Office-Home, VisDA, and DomainNet. |
| 41 | PASCAL-Context | Visual | [Site](https://cs.stanford.edu/~roozbeh/pascal-context/) | Mixed / PASCAL VOC 2010 terms | Full-scene semantic segmentation and context modeling | [Paper](https://www.cv-foundation.org/openaccess/content_cvpr_2014/papers/Mottaghi_The_Role_of_2014_CVPR_paper.pdf) | A classic dense-label benchmark built on VOC that still appears in scene-parsing comparisons. |
| 42 | NABirds | Visual | [Site](https://dl.allaboutbirds.org/nabirds) | Unknown | Fine-grained bird species recognition | [Paper](https://openaccess.thecvf.com/content_cvpr_2015_workshops/w19/html/Horn_Building_a_Bird_2015_CVPR_paper.html) | A larger and taxonomically richer bird benchmark than CUB, still common in FGVC work. |
| 43 | Stanford Dogs | Visual | [Site](http://vision.stanford.edu/aditya86/ImageNetDogs/main.html) | Unknown | Fine-grained dog breed recognition | [Paper](http://people.csail.mit.edu/khosla/papers/fgvc2011.pdf) | A long-running dog-breed benchmark still used in fine-grained classification and transfer-learning papers. |
