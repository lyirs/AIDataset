...
| 22 | MedMNIST | Medical imaging | [Site](https://medmnist.com/) | CC BY 4.0 | Lightweight standardized medical image classification benchmarks | [Paper](https://www.nature.com/articles/s41597-022-01721-8) | A widely used lightweight benchmark family spanning pathology, radiology, and organ-level image classification. |
| 23 | ADNI | Neuroimaging + clinical | [Site](https://adni.loni.usc.edu/) | Custom / application-based access | Alzheimer's disease progression modeling | [Docs](https://adni.loni.usc.edu/data-samples/access-data/) | One of the most important multimodal neuroimaging cohorts for dementia and longitudinal health modeling. |
| 24 | OASIS | Neuroimaging | [Site](https://sites.wustl.edu/oasisbrains/) | Custom / data use terms | Brain aging and dementia neuroimaging | [Docs](https://sites.wustl.edu/oasisbrains/#access) | A long-running open neuroimaging resource widely used in brain-aging and Alzheimer's studies. |
| 25 | HAM10000 | Dermoscopy images | [Site](https://complexity.cecs.ucf.edu/ham10000/) | Unknown | Skin lesion classification | [Paper](https://www.nature.com/articles/sdata2018161) | A canonical dermatology benchmark for skin-lesion diagnosis and visual classification. |
| 26 | RSNA Pneumonia Detection Challenge 2018 | Chest X-ray | [Site](https://www.rsna.org/artificial-intelligence/ai-image-challenge/rsna-pneumonia-detection-challenge-2018) | Unknown | Pneumonia detection and localization | [Docs](https://www.rsna.org/artificial-intelligence/ai-image-challenge/rsna-pneumonia-detection-challenge-2018) | A high-signal radiology challenge benchmark for lesion localization on chest radiographs. |
