...
| 13 | HetRec 2011 LastFM 2K | Music listening + tags | [Site](https://grouplens.org/datasets/hetrec-2011/) | Unknown | Music recommendation and social recommendation | [Paper](https://dl.acm.org/doi/10.1145/2043932.2043988) | A canonical music recommendation benchmark built on Last.fm user listening and tag data. |
| 14 | Adressa | English news + click logs | [Site](https://reclab.idi.ntnu.no/dataset/) | Custom / research access | Real-time news recommendation | [Paper](https://arxiv.org/abs/1808.03162) | One of the most reused public benchmarks for session-aware and streaming news recommendation. |
