...
| 多模态（Multimodal） | 视觉语言、VQA、图文对齐、图表与 OCR 感知推理、多模态指令数据。 | [英文](Multimodal/README.md) | [中文](Multimodal/README_ZH.md) | 24 |
...
| 综合评测（Benchmarks） | 覆盖 NLP、CV、多模态、检索、代码、Agent 与通用平台的跨领域评测套件。 | [英文](Benchmarks/README.md) | [中文](Benchmarks/README_ZH.md) | 19 |
