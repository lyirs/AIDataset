...
| 17 | Inria Aerial Image Labeling | Aerial imagery | [Site](https://project.inria.fr/aerialimagelabeling/) | Unknown | Building footprint segmentation from aerial imagery | [Paper](https://doi.org/10.1109/IGARSS.2017.8127684) | A classic high-resolution benchmark for building extraction and cross-city generalization. |
| 18 | LEVIR-CD | Aerial imagery | [Site](https://justchenhao.github.io/LEVIR/) | Academic use only / non-commercial | Building change detection from bi-temporal imagery | [Paper](https://arxiv.org/abs/2007.09244) | A canonical large-scale benchmark for remote-sensing change detection focused on building changes. |
| 19 | DeepGlobe | Satellite imagery | [Site](https://deepglobe.org/resources.html) | Challenge-only / custom terms | Road extraction, building detection, and land-cover segmentation | [Paper](https://openaccess.thecvf.com/content_cvpr_2018_workshops/w4/html/Demir_DeepGlobe_2018_A_CVPR_2018_paper.html) | A widely cited CVPR challenge dataset family for multiple remote-sensing segmentation tasks. |
| 20 | HRSCD | Aerial imagery | [Site](https://rcdaudt.github.io/hrscd/) | CC BY-NC-SA + source-data terms | Semantic change detection from high-resolution aerial imagery | [Paper](https://rcdaudt.github.io/files/2018cviu-hrscd.pdf) | A classic benchmark that goes beyond binary change masks to semantic land-cover change labels. |
| 21 | S2Looking | Satellite imagery | [GitHub](https://github.com/S2Looking/Dataset) | Unknown | Off-nadir building change detection | [Paper](https://arxiv.org/abs/2107.09244) | A newer high-signal change-detection benchmark designed to be more realistic than easier nadir-view pairs. |
| 22 | WHU Building Dataset | Aerial + satellite imagery | [Site](https://gpcv.whu.edu.cn/data/building_dataset.html) | Unknown | Building footprint extraction and large-scale segmentation | [Paper](https://doi.org/10.1109/TGRS.2018.2858817) | A standard building-extraction dataset family with high-quality vector and raster annotations. |
| 23 | DIOR | Aerial imagery | [Site](https://gcheng-nwpu.github.io/) | CC BY-NC 4.0 | Remote-sensing object detection with broad category coverage | [Paper](https://arxiv.org/abs/1909.00133) | One of the most widely reused large-scale object-detection benchmarks in optical remote sensing. |
