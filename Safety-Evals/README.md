...
| 17 | SALAD-Bench | English | [GitHub](https://github.com/OpenSafetyLab/SALAD-BENCH) | Apache-2.0 | Hierarchical LLM safety and jailbreak evaluation | [Paper](https://arxiv.org/abs/2402.05044) | Large-scale benchmark with harmful prompts, attack-enhanced variants, and MD-Judge-based evaluation. |
| 18 | AgentHarm | English | [HF](https://huggingface.co/datasets/ai-safety-institute/AgentHarm) | MIT + safety-use clause | Harmfulness evaluation for tool-using agents | [Paper](https://arxiv.org/abs/2410.09024) | A high-signal benchmark for explicitly malicious multi-step agent tasks; the public release is partial and hosted by UK AISI. |
| 19 | Do-Not-Answer | English | [HF](https://huggingface.co/datasets/LibrAI/do-not-answer) | CC BY-NC-SA 4.0 | Safeguard and refusal evaluation | [Paper](https://arxiv.org/abs/2308.13387) | A compact but widely cited benchmark for testing whether aligned models abstain on unsafe requests. |
| 20 | ToxiGen | English | [HF](https://huggingface.co/datasets/toxigen/toxigen-data) | Research use / gated access | Implicit toxicity and harmful-text safety evaluation | [Paper](https://arxiv.org/abs/2203.09509) | Frequently reused in toxicity, moderation, and harmful-generation benchmarking. |
